...
Fields shared across all genes are defined in the general [json file](json.md). The NEB locus includes the following unique field under `region_specific_info`:
