...
- `phasing_success`: Indicates whether the different haplotypes could be phased into alleles. Note that this does not refer to haplotype phasing itself; haplotypes can still be resolved even if they cannot be connected into alleles.
