...
- `fusions_called`: deletions or duplications from unequal crossing over between paralogs, called by checking the flanking sequences of phased haplotypes. Currently supported for: CYP2D6, GBA, CYP11B1, CLCNKB, CATSPER2 and the CFH gene cluster.
